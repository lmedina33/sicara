...
/**
 * RefPrestamo filter form base class.
 *
 * @package    sicara2
 * @subpackage filter
 ...
 */
abstract class BaseRefPrestamoFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ref_prestamo_filters[%s]');
