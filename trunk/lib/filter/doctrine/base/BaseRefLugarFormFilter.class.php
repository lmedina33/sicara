...
abstract class BaseRefLugarFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'id_ref_lugar_contenedor' => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('LugarContenedor'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      ...
      'id_ref_lugar_contenedor' => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('LugarContenedor'), 'column' => 'id_ref_lugar')),
  ...
  public function getFields()
  {
    return array(
      ...
      'ubicacion'               => 'Text',
      'id_ref_lugar_contenedor' => 'ForeignKey',
