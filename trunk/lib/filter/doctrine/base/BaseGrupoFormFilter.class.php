...
abstract class BaseGrupoFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'certificacion_primaria'   => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('Certificacion'), 'column' => 'id_certificacion')),
      'certificacion_secundaria' => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('Certificacion_2'), 'column' => 'id_certificacion')),
  ...
  public function getFields()
  {
    return array(
      ...
      'certificacion_secundaria' => 'ForeignKey',
      'fecha_inicio'             => 'Date',
      'fecha_fin'                => 'Date',
      'observaciones'            => 'Text',
