 ...
 * @property integer $created_by_sf_guard_user
 ...
 * @method integer     getCreatedBySfGuardUser()     Returns the current record's "created_by_sf_guard_user" value
 ...
 * @method RefHojaVida setCreatedBySfGuardUser()     Sets the current record's "created_by_sf_guard_user" value
...
abstract class BaseRefHojaVida extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('created_by_sf_guard_user', 'integer', 4, array(
             'type' => 'integer',
             'fixed' => 0,
             'unsigned' => true,
             'primary' => false,
