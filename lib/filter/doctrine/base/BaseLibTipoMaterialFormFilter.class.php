...
/**
 * LibTipoMaterial filter form base class.
 *
 * @package    sicara2
 * @subpackage filter
 ...
 */
abstract class BaseLibTipoMaterialFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'id_lib_tipo_sancion'  => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('LibTipoSancion'), 'column' => 'id_lib_tipo_sancion')),
    ));

    $this->widgetSchema->setNameFormat('lib_tipo_material_filters[%s]');
  ...
  {
    return array(
      'id_lib_tipo_material' => 'Number',
      'nombre'               => 'Text',
      'descripcion'          => 'Text',
      'dias_prestamo'        => 'Number',
      'cantidad_sancion'     => 'Number',
      'id_lib_tipo_sancion'  => 'ForeignKey',
    );
  }
}
