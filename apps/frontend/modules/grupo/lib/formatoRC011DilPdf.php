...
class FormatoRC011DilPdf extends FPDF {
    ...
    function Header() {
        ...
        $this->Cell(250, 5, 'REGISTRO PARCIAL DE CALIFICACIONES', 'LR', 1, 'C');
        $this->Cell(250, 5, '', 'LR', 1);
        ...
        $this->Cell(150, 5, 'NOMBRE Y APELLIDO', 1, 0, 'C');
        $this->SetFont('times', 'B', 6);
        $this->Cell(15, 5, 'PARCIAL I', 1, 0, 'C');
        $this->Cell(15, 5, 'PARCIAL II', 1, 0, 'C');
        $this->Cell(15, 5, 'PARCIAL III', 1, 0, 'C');
        $this->Cell(15, 5, 'DEFINITIVA', 1, 0, 'C');
        $this->Cell(15, 5, 'NIVELACION', 1, 1, 'C');
    }
    ...
    function generar() {
        ...
        foreach ($this->elemento as $estudianteHas) {
            ...
            $this->Cell(150, 5, $estudianteHas->getEstudiante()->getUsuario()->getPrimerApellido() . " " . $estudianteHas->getEstudiante()->getUsuario()->getSegundoApellido() . " " . $estudianteHas->getEstudiante()->getUsuario()->getPrimerNombre() . " " . $estudianteHas->getEstudiante()->getUsuario()->getSegundoNombre(), 1, 0, 'L');
            ...
            if (isset($this->notas[$estudianteHas->getEstudiante()->getCodigoEstudiante()])) {
                ...
                $this->Cell(15, 5, intval($data['parcial1']), 1, 0, 'C');
                $this->Cell(15, 5, intval($data['parcial2']), 1, 0, 'C');
                $this->Cell(15, 5, intval($data['parcial3']), 1, 0, 'C');
                $this->Cell(15, 5, intval($data['definitiva']), 1, 0, 'C');
                $this->Cell(15, 5, intval($data['nivelacion']), 1, 1, 'C');
            } else {
