...
class FormatoRC003Pdf extends FPDF {
    ...
    function Header() {
        ...
        $this->Cell(250, 5, 'REGISTRO GENERAL DE ASISTENCIA', 'LR', 1, 'C');
        $this->Cell(250, 5, '', 'LR', 1);
        ...
        $this->Cell(5, 5, '', 1, 0);
        $this->Cell(5, 5, '', 1, 0);
        $this->Cell(10, 5, 'HI', 1, 0, 'C');
        $this->Cell(10, 5, 'HA', 1, 1, 'C');
    }
    ...
    function Footer() {
        ...
        $this->Cell(210, 5, '', 'LR', 0);  //20
        $this->Cell(35, 5, 'HI: Horas Inasistencia', 'LTR', 0);
        $this->Cell(5, 5, '', 'R', 1);
        $this->Cell(210, 5, '', 'LR', 0);
        $this->Cell(35, 5, 'HA: Horas Asistidas', 'LTR', 0);
        $this->Cell(5, 5, '', 'R', 1);
        $this->Cell(210, 5, '', 'LR', 0);
        $this->Cell(35, 5, '2: Asistencia', 'LTR', 0);
        $this->Cell(5, 5, '', 'R', 1);
        ...
        $this->Cell(15, 5, '', 0, 0);
        $this->Cell(35, 5, '0: Inasistencia', 1, 0);
        $this->Cell(5, 5, '', 'R', 1);
